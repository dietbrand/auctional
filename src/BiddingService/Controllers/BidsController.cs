...
public class BidsController : ControllerBase
{
  ...
  private readonly IPublishEndpoint _publishEndpoing;
  private readonly GrpcAuctionClient _grpcClient;

  public BidsController(IMapper mapper, IPublishEndpoint publishEndpoing, GrpcAuctionClient grpcClient)
  {
    _mapper = mapper;
    _publishEndpoing = publishEndpoing;
  ...
  public async Task<ActionResult<BidDto>> PlaceBid(string auctionId, int amount)
  {
    ...
    await _publishEndpoing.Publish(_mapper.Map<BidPlaced>(bid));
